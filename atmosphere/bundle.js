...
var frag = glslify(["precision highp float;\n#define GLSLIFY 1\n#define GLSLIFY 1\n#define GLSLIFY 1\n#define GLSLIFY 1 \n\nvarying vec3 vPosition; \n\nuniform vec3 uSunPos; \n\n#define PI 3.141592\n#define iSteps 16\n#define jSteps 8\n\nfloat rsi(vec3 r0, vec3 rd, float sr) {\n    // Simplified ray-sphere intersection that assumes\n    // the ray starts inside the sphere and that the\n    // sphere is centered at the origin. Always intersects.\n    float a = dot(rd, rd);\n    float b = 2.0 * dot(rd, r0);\n    float c = dot(r0, r0) - (sr * sr);\n    return (-b + sqrt((b*b) - 4.0*a*c))/(2.0*a);\n}\n\nfloat rso(vec3 r0, vec3 rd, float sr) {\n    // ray sphere intersection that assumes that ray starts outside.\n    // returns -1 if ray will not intersect\n    float a = dot(rd, rd);\n    float b = 2.0 * dot(rd, r0);\n    float c = dot(r0, r0) - (sr * sr);\n    float det = (b*b) - 4.0*a*c;\n    \n    if(det < float(0))\n        return float(-1);\n    \n    return (-b - sqrt(det))/(2.0*a);\n}\n\nvec3 atmosphere(vec3 r, vec3 r0, vec3 pSun, float iSun, float rPlanet, float rAtmos, vec3 kRlh, float kMie, float shRlh, float shMie, float g) {\n    // Normalize the sun and view directions.\n    pSun = normalize(pSun);\n    r = normalize(r);\n\n    // Calculate the step size of the primary ray.\n    \n    // what do we hit first, the ground? or the other side of the atmosphere?\n    float ground_dist = rso(r0, r, rPlanet); // -1 if miss.\n    float atm_dist = rsi(r0, r, rAtmos);\n    \n    float dist = ground_dist > 0.0 ? ground_dist : atm_dist;\n    \n    \n    float iStepSize = dist / float(iSteps);\n\n    // Initialize the primary ray time.\n    float iTime = 0.0;\n\n    // Initialize accumulators for Rayleight and Mie scattering.\n    vec3 totalRlh = vec3(0,0,0);\n    vec3 totalMie = vec3(0,0,0);\n\n    // Initialize optical depth accumulators for the primary ray.\n    float iOdRlh = 0.0;\n    float iOdMie = 0.0;\n\n    // Calculate the Rayleigh and Mie phases.\n    float mu = dot(r, pSun);\n    float mumu = mu * mu;\n    float gg = g * g;\n    float pRlh = 3.0 / (16.0 * PI) * (1.0 + mumu);\n    float pMie = 3.0 / (8.0 * PI) * ((1.0 - gg) * (mumu + 1.0)) / (pow(1.0 + gg - 2.0 * mu * g, 1.5) * (2.0 + gg));\n\n    // Sample the primary ray.\n    for (int i = 0; i < iSteps; i++) {\n\n        // Calculate the primary ray sample position.\n        vec3 iPos = r0 + r * (iTime + iStepSize * 0.5);\n\n        // Calculate the height of the sample.\n        float iHeight = length(iPos) - rPlanet;\n\n        // Calculate the optical depth of the Rayleigh and Mie scattering for this step.\n        float odStepRlh = exp(-iHeight / shRlh) * iStepSize;\n        float odStepMie = exp(-iHeight / shMie) * iStepSize;\n\n        // Accumulate optical depth.\n        iOdRlh += odStepRlh;\n        iOdMie += odStepMie;\n\n        // Calculate the step size of the secondary ray.\n        float second_dist = rsi(iPos, pSun, rAtmos);\n        float jStepSize =  second_dist / float(jSteps);\n\n        // Initialize the secondary ray time.\n        float jTime = 0.0;\n\n        // Initialize optical depth accumulators for the secondary ray.\n        float jOdRlh = 0.0;\n        float jOdMie = 0.0;\n\n        // Sample the secondary ray.\n        for (int j = 0; j < jSteps; j++) {\n\n            // Calculate the secondary ray sample position.\n            vec3 jPos = iPos + pSun * (jTime + jStepSize * 0.5);\n\n            // Calculate the height of the sample.\n            float jHeight = length(jPos) - rPlanet;\n\n            // Accumulate the optical depth.\n            jOdRlh += exp(-jHeight / shRlh) * jStepSize;\n            jOdMie += exp(-jHeight / shMie) * jStepSize;\n\n            // Increment the secondary ray time.\n            jTime += jStepSize;\n        }\n\n        // Calculate attenuation.\n        vec3 attn = exp(-(kMie * (iOdMie + jOdMie) + kRlh * (iOdRlh + jOdRlh)));\n\n        // Accumulate scattering.\n        totalRlh += odStepRlh * attn;\n        totalMie += odStepMie * attn;\n\n        // Increment the primary ray time.\n        iTime += iStepSize;\n\n       // return vec3( rsi(iPos, pSun, rAtmos)/10000e3 , 0,0);\n\n    }\n\n    // Calculate and return the final color.\n    return iSun * (pRlh * kRlh * totalRlh + pMie * kMie * totalMie);\n    \n    // measure ray length:\n    //return vec3(rsi(r0, r, rAtmos)/13000e3, 0,0); ;\n    //return vec3(dist/100e3, 0,0);\n    \n    // measure secondary ray length:\n    \n    \n}\n\nvoid main() {\n    // skip render color\n    vec3 color = vec3(0.0,0.0,0.0);\n    \n    // vPosition sweeps ([-1,1], [-1,1], -1)\n    float fovAdjust = 100.0; // the higher the number, the narrower the FOV. (eg: looking from afar). you get more of a halo effect as the camera gets farther.\n    vec3 r0 = vec3(0,0,10471e3) * fovAdjust; // ray origin\n    float atm_r = 6471e3; //radius of the atmosphere in meters\n    float planet_r = 6371e3; // radius of the planet in meters\n    \n    vec3 lookdir = vPosition;\n    lookdir.z = -fovAdjust;\n    vec3 rd = normalize(lookdir); // ray dir.\n\n    float dist_to_atm = rso(r0, rd, atm_r);\n    \n\t//vec3 ground_start = vec3(0, planet_r, 0);\n\n    if(dist_to_atm >= 0.0) {\n        // ray hits edge of atmosphere\n        // new start.\n        vec3 r1 = r0 + (rd * (dist_to_atm));\n\n        color = atmosphere(\n            rd,           // normalized ray direction\n            r1,               // ray origin\n            uSunPos,                        // position of the sun\n            22.0,                           // intensity of the sun\n            planet_r,                        \n            atm_r,                         // radius of the atmosphere in meters\n            vec3(5.5e-6, 13.0e-6, 22.4e-6), // Rayleigh scattering coefficient\n            21e-6,                          // Mie scattering coefficient\n            8e3,                            // Rayleigh scale height\n            1.2e3,                          // Mie scale height\n            0.758                           // Mie preferred scattering direction\n        );\n        \n        // debug: confirm ray is on top of atmosphere. (outputs grey)\n        //color = vec3(dot(r1,r1) / (2.0*atm_r*atm_r));\n        \n    }\n    \n\n    // Apply exposure.\n    color = 1.0 - exp(-1.0 * color);\n    //color = color*1000000000.0;\n        \n    gl_FragColor = vec4(color, 1);\n}"]);
var program = glShader(gl, vert, frag, null, null);
function reflow() {
...
function render() {
    ...
    program.bind();
    quad.bind(program);
    program.uniforms.uSunPos = [0, Math.cos(theta), Math.sin(theta)];
    quad.draw();
    requestAnimationFrame(render);
}
render();

},{"gl-geometry":16,"gl-shader":18,"glslify":38}],2:[function(require,module,exports){
...
},{"pad-left":45}],3:[function(require,module,exports){
...
},{"uniq":49}],9:[function(require,module,exports){
"use strict"
...
},{"ndarray":44,"ndarray-ops":43,"typedarray-pool":48}],13:[function(require,module,exports){
module.exports = {
  0: 'NONE',
  1: 'ONE',
  2: 'LINE_LOOP',
...
},{"add-line-numbers":2,"gl-constants/lookup":14,"glsl-shader-name":30,"sprintf-js":47}],16:[function(require,module,exports){
...
},{"./normalize":17,"dtype":10,"gl-to-dtype":25,"gl-vao":29}],17:[function(require,module,exports){
...
},{"array-pack-2d":3,"dtype":10,"gl-buffer":12,"is-typedarray":41,"isndarray":42}],18:[function(require,module,exports){
'use strict'
...
},{"./GLError":19,"gl-format-compiler-error":15,"weakmap-shim":52}],25:[function(require,module,exports){
...
},{"./lib/vao-emulated.js":27,"./lib/vao-native.js":28}],30:[function(require,module,exports){
...
},{"atob-lite":5,"glsl-tokenizer":37}],31:[function(require,module,exports){
...
},{"./lib/builtins":33,"./lib/builtins-300es":32,"./lib/literals":35,"./lib/literals-300es":34,"./lib/operators":36}],32:[function(require,module,exports){
...
},{"./builtins":33}],33:[function(require,module,exports){
module.exports = [
...
},{"./literals":35}],35:[function(require,module,exports){
module.exports = [
  // current
    'precision'
  , 'highp'
...
},{"./index":31}],38:[function(require,module,exports){
...
},{"iota-array":39,"is-buffer":40}],45:[function(require,module,exports){
/*!
...
},{"repeat-string":46}],46:[function(require,module,exports){
/*!
...
},{"bit-twiddle":6,"buffer":53,"dup":11}],49:[function(require,module,exports){
"use strict"
